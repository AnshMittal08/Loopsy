      ...
      parts: {
        ...
        items: {
          ...
          properties: {
            ...
            dimensions: {
              type: "object",
              description: "Real-world finished dimensions in cm. sphere/hemisphere/flatCircle/flatHexagon: diameterCm. ellipsoid: diameterCm (widest cross-section) + heightCm (long axis). tube: heightCm + diameterCm or circumferenceCm. taperedTube: bottomDiameterCm + topDiameterCm + heightCm. cone: baseDiameterCm + heightCm. flatPanel: widthCm + heightCm. triangle: baseCm. star: sizeCm. heart: widthCm. grannySquare: sideCm. hatCrown: size keyword instead. splitLimbBody: limbDiameterCm + limbHeightCm + bodyDiameterCm + bodyHeightCm. raglanSweater/sock/mitten: size keyword instead (raglanSweater: baby|child|adult-s|adult-m|adult-l|adult-xl; sock/mitten: child|adult-s|adult-m|adult-l).",
              properties: {
                ...
                size: { type: "string", description: "Keyword-sized shapes only. hatCrown: baby|toddler|child|teen|adult-s|adult-m|adult-l. raglanSweater: baby|child|adult-s|adult-m|adult-l|adult-xl. sock/mitten: child|adult-s|adult-m|adult-l." },
              },
            },
...
Decompose the pictured object into the supported shapes (${SUPPORTED_SHAPES.join(", ")}). Amigurumi are typically spheres (heads), ellipsoids (bodies), cones (limbs, beaks), tubes (arms, legs, tails) and flat panels (ears); when the legs visibly flow into the body as one continuous piece, use splitLimbBody. If the fabric shows bobbles, popcorn, shells/scallops, or ribbed ridges, set that part's texture field. A pictured pullover, sock, or mitten maps to the raglanSweater/sock/mitten shapes with a size keyword. Estimate realistic finished dimensions in cm from visual cues; if the photo gives no scale, make a sensible guess and lower your confidence. Be honest with "feasible": fitted garments beyond sweaters/socks/mittens (cardigans, lace shawls, tailored shaping) and complex picture colorwork are NOT feasible. Always fill "observed" with what a maker would recognize, and set "confidence" truthfully.`,
        cache_control: { type: "ephemeral" },
      },
    ],
    messages: [
